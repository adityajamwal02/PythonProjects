...
root.title("Aditya's Name generator")
root.iconbitmap(r'C:\Users\DELL\Downloads')

l = Label(root,text="Aditya's Name Generator App",font=('verdana',15,'bold'),bg="maroon",fg="white")
l.place(x=180, y=10)
